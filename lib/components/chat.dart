...
import 'package:awesome_help/components/markdown.dart';
import 'package:awesome_help/components/prompts.dart';
...
class _ChatWindowState extends State<ChatWindow> {
  ...
  void _sendMessage() {
    ...
    if (message.isNotEmpty) {
      ...
      messageController.addMessage(newMessage, _handleMessageComplete());
  ...
  void _handleKeyEvent(RawKeyEvent value) {
    if (value.isKeyPressed(LogicalKeyboardKey.enter) && isEnable) {
      _sendMessage();
    }
  }

  Function? _handleMessageComplete() {
    return () {
      isEnable = true;
    };
  }
